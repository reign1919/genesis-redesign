-- Migration: 20260924000001_reopen_participant_editing.sql
-- Description: Reopens participant roster editing for a single school (Birla High School, GEN-0050)
-- via a per-school flag. All other schools remain closed. Flip the flag back to false to close again.
...
-- 2. Target school: Birla High School (GEN-0050)
update public.schools
set participant_editing_open = true
where school_code = 'GEN-0050'
   or name ilike 'Birla High School%';
