  ...
  return (
    <div className="m-sponsors-wrapper">
      <SEO
        ...
        description="Meet the official sponsors and partners supporting Genesis 2026 Tech Fest: Yes Bank, n8n, .xyz, 91.9 Friends FM, The Telegraph: Young Metro, and React Kolkata."
        canonical="/sponsors"
      />
