...
export const eventsData = [
  ...
  // ── CREATIVE CLUSTER (3 Events - Right Branch) ───────────────────
  {
    ...
    reelIndex: '08',
    title: 'PIXEL PRIX',
    brief: 'Live digital art competition where participants create original artwork based on a surprise prompt.',
    category: EVENT_CLUSTERS.CREATIVE,
    flagship: false,
    gridPosition: { x: 78, y: 60 },
    date: 'SEPTEMBER 26, 2026',
    teamSize: '1 PARTICIPANT PER TEAM (SOLO)',
    formatMode: 'Fixed Time Limit (90+15 Minutes)',
    keyPolicy: 'Strictly No Generative AI | Bring Own Laptop/Tablet',
    deliverable: 'Exported Digital Artwork File (PNG/JPEG)',
    visualType: 'VECTOR_CANVAS_GRID',
    rules: [
      'Team Composition: 1 participant per team (Solo).',
      'Equipment & Software: Participants must bring their own laptop or tablet plus software of their choice (Procreate, Photoshop, Illustrator, Krita, etc.).',
      'Theme Reveal: A theme or prompt is revealed at the start of the session.',
      'Live Creation: All art must be created live within the event window; strictly no pre-made bases or drafts.',
      'Timeline: Fixed time limit of 90+15 minutes; the final file must be exported and submitted when time is up.',
      'Allowed: Any digital painting, illustration, or drawing software and brushes of choice.',
      'Prohibited: STRICTLY NO AI ALLOWED (all generative AI tools are banned), no pre-existing artwork or imported templates.'
    ]
  },
  {
    id: 'reel-deal',
    reelIndex: '09',
    title: 'REEL DEAL',
    brief: 'Create a vertical video (60s minimum to 120s maximum) capturing the excitement and preparation for Genesis Fest.',
    category: EVENT_CLUSTERS.CREATIVE,
    flagship: false,
    gridPosition: { x: 64, y: 74 },
    date: 'DAYS LEADING UPTO GENESIS (DUE SEPT 25)',
    teamSize: '3 MEMBERS PER TEAM',
    formatMode: 'Submit Public Instagram Reel Link by Sept 25',
    keyPolicy: 'Original Footage Only (No Stock Videos)',
    deliverable: 'Public Instagram Reel Link (60s–120s Vertical 9:16)',
    visualType: 'VERTICAL_REEL_WAVEFORM',
    rules: [
      'Team Composition: 3 members per team.',
      'Task: Capture the excitement, hustle, and spirit of your school preparation for Genesis Fest (behind-the-scenes prep, rehearsals, team spirit).',
      'Submission: Final export must be submitted as a public Instagram reel link on the 25th of September.',
      'Theme: "Preparing for Genesis Fest" (showcase behind-the-scenes action, practice sessions, art creation, general enthusiasm).',
      'Duration: 60s minimum to 120s maximum.',
      'Format & Submission: Vertical 9:16 aspect ratio (e.g. 1080x1920 pixels), submitted as a public Instagram reel link. English language only.',
      'Allowed: Smartphones, DSLRs, mirrorless/action cameras, any video editing app or software (Premiere, CapCut, InShot, DaVinci), trending audio tracks, royalty-free music, voiceovers, text overlays, VFX, featuring school banners/teachers with permission.',
  ...
  },
  {
    ...
    deliverable: '2 to 4 Photo Entries (Minimum 2, Maximum 4)',
